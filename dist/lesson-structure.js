...
exports.createContentQuestion = exports.createVideoQuestion = exports.getQuestionsByCategory = exports.getLessonTypeConfig = exports.getUnitByLessonId = exports.getChapterByLessonId = exports.getLessonById = exports.UNIT_STRUCTURE = exports.LESSON_TYPE_CONFIG = exports.QuestionCategories = void 0;
...
const getLessonById = (lessonId) => {
    for (const unit of exports.UNIT_STRUCTURE) {
...
exports.getChapterByLessonId = getChapterByLessonId;
const getUnitByLessonId = (lessonId) => {
    for (const unit of exports.UNIT_STRUCTURE) {
        for (const chapter of unit.chapters) {
            const lesson = chapter.lessons.find(l => l.id === lessonId);
            if (lesson)
...
exports.getUnitByLessonId = getUnitByLessonId;
const getLessonTypeConfig = (lessonType) => {
    return exports.LESSON_TYPE_CONFIG[lessonType];
};
exports.getLessonTypeConfig = getLessonTypeConfig;
const getQuestionsByCategory = (_category) => {
...
const createVideoQuestion = (id, category, prompt, videoSrc, correctLabel, distractorLabels, distractorVideos) => {
    const answerOptions = [
        {
            label: correctLabel,
            isCorrect: true,
...
exports.createVideoQuestion = createVideoQuestion;
const createContentQuestion = (id, category, prompt, videoSrc, title) => {
    return {
        id,
        type: 'CONTENT',
        category,
...
exports.createContentQuestion = createContentQuestion;
